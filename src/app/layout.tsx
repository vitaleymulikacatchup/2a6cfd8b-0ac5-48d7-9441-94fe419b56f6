...
export const metadata: Metadata = {
  title: "Nanzi Apparel | Modern Men's Fashion",
  description: "Discover the latest in men's fashion with Nanzi Apparel. Elegant designs for every occasion.",
  openGraph: {
    title: "Nanzi Apparel | Modern Men's Fashion",
    description: "Discover the latest in men's fashion with Nanzi Apparel. Elegant designs for every occasion.",
    url: "https://www.nanziapparel.com",
    siteName: "Nanzi Apparel",
    images: [{ url: "https://images.pexels.com/photos/298863/pexels-photo-298863.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" }],
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "Nanzi Apparel | Modern Men's Fashion",
    description: "Discover the latest in men's fashion with Nanzi Apparel.",
  },
  robots: {
    index: true,
    follow: true,
